...
int case1(int x, int y) {
    int a = 0, b = 0;
    FOR(k,0,400) {
        if ((col[x][k] == 1 && col[y][k] == 4) || (col[x][k] == 4 && col[y][k] == 1)) a++;
        if ((col[x][k] == 2 && col[y][k] == 3) || (col[x][k] == 3 && col[y][k] == 2)) b++;
    }
    return a*b;
} 
...
int case2(int x, int y) {
    int a = 0, b = 0;
    FOR(k,0,400) {
        if ((col[x][k] == 1 && col[y][k] == 3) || (col[x][k] == 3 && col[y][k] == 1)) a++;
        if ((col[x][k] == 2 && col[y][k] == 4) || (col[x][k] == 4 && col[y][k] == 2)) b++;
    }
    return a*b;
} 
...
int case3(int x, int y) {
    int a = 0, b = 0;
    FOR(k,0,400) {
        if ((col[x][k] == 1 && col[y][k] == 2) || (col[x][k] == 2 && col[y][k] == 1)) a++;
        if ((col[x][k] == 4 && col[y][k] == 3) || (col[x][k] == 3 && col[y][k] == 4)) b++;
    }
    return a*b;
} 
...
void sol() {
    int ans = 0;
    FOR(i,0,400) FOR(j,i+1,400) {
        ans += case1(i,j) + case2(i,j) + case3(i,j);
    }
    cout << ans;
}
